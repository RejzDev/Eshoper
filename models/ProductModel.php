    ...
    class ProductModel
    {
        ...
        public static function getProductsListByCategory($categoryId = false, $page = 1)
        {
            if ($categoryId) {
                ...
                $result = $db->query("SELECT  id, name, price, image, is_new FROM product "
                    . "WHERE status = '1' AND category_id = '$catId' ORDER BY id DESC LIMIT " . self::SHOW_BY_DEFAULT
                    . " OFFSET '$offset'" );
        ...
        /**
         * Возвращает список товаров по ID
         * @param $productsIds
         * @return array
         */
        public static function getProductItemsByIds($productsIds)
        {
            ...
            $sql = "SELECT * FROM product WHERE status='1' AND id IN ($productsId)";
